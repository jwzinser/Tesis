...
## Utilidad medida por medio de mÃ©todos de aprendizaje de mÃ¡quina.
## No incluir el valor real presenta una mejor utilidad.
---
class: center, bottom, inverse
background-image: url(file:///home/juanzinser/Documents/plots/dataday/privacy_auc_t.png)
background-size: 512px
background-position: 45% 10%
## Destaca la estabilidad en los dos "escalones".
---
class: center, bottom, inverse
background-image: url(file:///home/juanzinser/Documents/plots/dataday/privacy_auc_f.png)
background-size: 512px
background-position: 45% 10%
...
## El modelo Naive Bayes tiene un mejor desempeÃ±o cuando el valor real no es incluido sobre el Ã¡rbol de regresión, mientras que los demÃ¡s modelos tienen un comportamiento independiente de la inclusión del valor real.
---
class: center, bottom
...
background-size: 512px
background-position: 45% 10%
## DespuÃ©s de un nivel de dispersiÃ³n mayor al 40%, pierde relevancia la inclusiÃ³n o no inclusiÃ³n del valor real. 
---
class: center, bottom, inverse
